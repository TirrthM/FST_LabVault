    ...
    extend: {
      colors: {
        ...
        status: {
          ...
          calibration: "hsl(var(--status-calibration))",
          "calibration-foreground": "hsl(var(--status-calibration-foreground))",
          reserved: "hsl(var(--status-reserved))",
          "reserved-foreground": "hsl(var(--status-reserved-foreground))",
          retired: "hsl(var(--status-retired))",
          "retired-foreground": "hsl(var(--status-retired-foreground))",
        }
      },
      borderRadius: {
        lg: "var(--radius)",
